...
public class TenantController {
    ...
    public ResponseEntity<List<Tenant>> loadAll() {
        LOGGER.info("start loadAll users");
        try {
            List<Tenant> users = service.findAll();
    ...
    public ResponseEntity<Tenant> loadOne(@PathVariable int id) {
        LOGGER.info("start loadOne user by id: ", id);
        try {
            Optional<Tenant> user = service.find(id);
    ...
    public ResponseEntity<Tenant> create(@RequestBody Tenant object) {
    ...
    public ResponseEntity<Tenant> update(@PathVariable int id, @RequestBody Tenant object) {
